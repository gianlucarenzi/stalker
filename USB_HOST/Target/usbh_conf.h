...
/*----------   -----------*/
#ifndef USBH_DEBUG_LEVEL_OVERRIDE
	#define USBH_DEBUG_LEVEL      0U
#else
	#define USBH_DEBUG_LEVEL      USBH_DEBUG_LEVEL_OVERRIDE
#endif
...
#define HOST_FS 		1
  ...
  #define USBH_PROCESS_STACK_SIZE    ((uint16_t)1536)  // Balanced for 64KB RAM limit
#endif /* (USBH_USE_OS == 1) */
...
#define  USBH_UsrLog(...)   DBG_V(__VA_ARGS__); printf("\r\n");
#else
#define USBH_UsrLog(...) do {} while (0)
#endif

/* ErrLog always active */
#define  USBH_ErrLog(...) DBG_E(__VA_ARGS__); printf("\r\n");

#if (USBH_DEBUG_LEVEL > 2U)
#define  USBH_DbgLog(...)   DBG_N(__VA_ARGS__); printf("\r\n"); 
#else
