...
//	DBG_N("Called with phost %p\r\n", phost);
  ...
  case HOST_INPUT:
    {
      ...
      {
		  DBG_N("No user defined function\r\n");
	  }
    }
    break;
  ...
  case HOST_CHECK_CLASS:
    DBG_N("HOST CHECK CLASS\r\n");
    if(phost->ClassNumber == 0)
    {
      USBH_UsrLog ("No Class has been registered.");
      DBG_N("No Class has been registered.\r\n");
    }
    else
    {
      phost->pActiveClass = NULL;
      ...
      if(phost->pActiveClass != NULL)
      {
        ...
        else
        {
          ...
          DBG_N("Device not supporting %s class.\r\n", phost->pActiveClass->Name);
        }
      }
      else
      {
        ...
        DBG_N("No registered class for this device.\r\n");
      }
    }
  ...
  case ENUM_GET_MFC_STRING_DESC:
    ...
    { /* Check that Manufacturer String is available */
                               ...
                               0xff) == USBH_OK)
      {
        ...
        DBG_I("Manufacturer : %s\n\r",  (char *)phost->device.Data);
