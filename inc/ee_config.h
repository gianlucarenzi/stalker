...
#define EE_SELECTED_PAGE_SECTOR_NUMBER    5 // Sector 5 for STM32F401xC
#define EE_SELECTED_PAGE_SECTOR_SIZE      EE_PAGE_SECTOR_SIZE_128K // 128KB
#define EE_SELECTED_BANK                  FLASH_BANK_1 // STM32F401xC has only one flash bank
#define EE_SELECTED_ADDRESS               0x08020000 // Start of Sector 5
#endif
