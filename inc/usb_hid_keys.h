...
/**
  ...
  * These are the standard USB HID keyboard scancodes
  *
  ******************************************************************************
  */
...
/* USB HID Keyboard Scancodes (Usage Page 0x07) */
...
/* Modifier masks */
#define MOD_L_CTRL_Msk                         (1 << 0)
#define MOD_L_SHIFT_Msk                        (1 << 1)
#define MOD_L_ALT_Msk                          (1 << 2)
#define MOD_L_GUI_Msk                          (1 << 3)
#define MOD_R_CTRL_Msk                         (1 << 4)
#define MOD_R_SHIFT_Msk                        (1 << 5)
#define MOD_R_ALT_Msk                          (1 << 6)
#define MOD_R_GUI_Msk                          (1 << 7)
